...
const MongoStore = MongoStoreModule.create ? MongoStoreModule : (MongoStoreModule.default || MongoStoreModule.MongoStore || MongoStoreModule);
...
// Security: Add standard HTTP security headers
